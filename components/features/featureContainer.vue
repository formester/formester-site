    ...
    <div class="container py-5">
      ...
      <div class="row flex justify-content-between mt-40px">
        <div class="col-xl-6 flex flex-column">
          ...
          <div class="feature__contentCard mt-4" :class="{ active2: activeCard === 2 }" @click="setActiveCard(2)">
            <h3>{{ feature.contents[1].title }}</h3>
            <p>{{ feature.contents[1].description }}</p>
          </div>
          <div class="feature__contentCard mt-4" :class="{ active3: activeCard === 3 }" @click="setActiveCard(3)">
            <h3>{{ feature.contents[2].title }}</h3>
            <p>{{ feature.contents[2].description }}</p>
          </div>
          <NuxtLink :to="`/features/${feature.link}/`" class="feature__link d-flex align-items-center mt-4">
