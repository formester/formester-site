    ...
    <nav class="navbar navbar-expand-xl floating-navbar">
      <div class="container d-flex align-items-center">
        ...
        <div class="nav-mobile-actions">
          <FButton href="https://app.formester.com/users/sign_in" variant="text" size="sm" class="nav-login-btn">Log in</FButton>
          <FButton v-if="!isMobile" href="https://app.formester.com/users/sign_up" variant="primary" size="sm">Start free</FButton>
