      ...
      >
        ...
        <div class="plugins-list">
          ...
          <NuxtLink to="/plugins/wordpress/" class="plugin-item" @click="$emit('dropdown-close')">
            <span class="plugin-item__icon"><nuxt-img src="/integrations/wordpress.svg" alt="WordPress" width="28" height="28" style="object-fit:contain" /></span>
          ...
          <NuxtLink to="/plugins/webflow/" class="plugin-item" @click="$emit('dropdown-close')">
            <span class="plugin-item__icon"><nuxt-img src="/integrations/webflow.svg" alt="Webflow" width="28" height="28" style="object-fit:contain" /></span>
            <span class="plugin-item__body">
          ...
          <NuxtLink to="/plugins/wix-forms/" class="plugin-item" @click="$emit('dropdown-close')">
            <span class="plugin-item__icon"><nuxt-img src="/integrations/wix.svg" alt="Wix" width="28" height="28" style="object-fit:contain" /></span>
            <span class="plugin-item__body">
          ...
          <NuxtLink to="/plugins/shopify-form-builder/" class="plugin-item" @click="$emit('dropdown-close')">
            <span class="plugin-item__icon"><nuxt-img src="/integrations/shopify.svg" alt="Shopify" width="28" height="28" style="object-fit:contain" /></span>
            <span class="plugin-item__body">
          ...
          <NuxtLink to="/plugins/canva-form-builder/" class="plugin-item" @click="$emit('dropdown-close')">
            <span class="plugin-item__icon"><nuxt-img src="/integrations/canva.svg" alt="Canva" width="28" height="28" style="object-fit:contain" /></span>
            <span class="plugin-item__body">
          ...
          <NuxtLink to="/plugins/slack-forms/" class="plugin-item" @click="$emit('dropdown-close')">
            <span class="plugin-item__icon">
              <nuxt-img src="/integrations/slack.png" alt="Slack" width="28" height="28" style="object-fit:contain" />
            </span>
            <span class="plugin-item__body">
