  ...
  <section class="uc-grid">
    <div class="uc-grid__inner">
      ...
      <div class="uc-grid__cards">
        <div v-for="(item, idx) in usecases" :key="item.id || idx" class="uc-grid__card">
          ...
          <div v-if="item.image?.url" class="uc-grid__card-img-wrap flex align-center">
