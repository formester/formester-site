...
<p>Turn on <strong>Make this a quiz</strong> in Settings, then open each question and set an answer key and a point value. Google marks every submission against those keys automatically. What catches people out is that only half the question types can carry an answer key at all.</p>
<ul>
...
![Image showing the **Start a New Form** Section and the **plus (+)** icon on the Blank Form Template](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_4_f59be5dd03.png "**Start a New Form** Section and the **plus (+)** icon on the Blank Form Template")
...
![Image showing **Untitled Form** and **Quiz Description** section](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_5_e76dcf710c.png "**Untitled Form** and **Quiz Description** section")
...
![Image showing the **Make this a quiz** toggle under the **Settings** section](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_6_8758a9621b.png " **Make this a quiz** feature")
...
![Image showing **Untitled Question** section under **Question Tab** and set as **Required** toggle](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_7_c2051c161c.png "**Untitled Question** section under **Question Tab** and set as **Required** toggle")
...
![Image showing **Feature Panel**, **Add New Fields** and **Duplicate** buttons](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_8_ef7fa7f439.png " **Feature Panel**, **Add New Fields** and **Duplicate** buttons")
...
![Image showing the **Answer key** button](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_9_a92776ff43.png "**Answer key** button")

C﻿hoose the **correct response**.

![Image showing the **correct response** being selected](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_10_a53a7931de.png "C﻿hoose the **correct response**")
...
![Image showing the **Add a feedback** section expanded and **Add videos**/ ** Add video URL** buttons](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_15_99a2b6882a.png "**Add a feedback** section expanded and **Add videos**/ ** Add video URL** buttons")
...
After the preview, just click on the **Publish** button to **publish** your quiz.

After you've received submissions, you may head over to the **Responses** section to analyze your responders' performance.

![Image showing the **Responses** section expanded including **Question Tab**, **Individual Tab** and **Link to Integrate with Google Sheets**](https://formester-strapi.s3.ap-south-1.amazonaws.com/use_as_needed_13_b8e42d5ed0.png "The **Responses** section, **Question Tab**, **Individual Tab** and **Link to Integrate with Google Sheets**")
...
![Google Forms answer key panel with Mitochondrion marked correct and the question set to 2 points](https://formester-strapi.s3.ap-south-1.amazonaws.com/gforms_s2_answer_key_points_427e99112a.jpg)

- **Points default to zero.** A question with an answer key and no point value is marked correct and adds nothing to the total. Set the number explicitly on every question.
- **Decimals are discarded.** Enter 2.5 points and Google keeps 2. Scale the whole quiz up rather than using fractions.
- **Short answer is exact-match.** A near miss is left **ungraded** rather than marked wrong, so someone has to review it by hand. For anything with spelling variation, use multiple choice instead.
- **Checkboxes are all-or-nothing.** Partial selections score zero. There is no partial credit anywhere in Google Forms.

![Google Forms grading view where Photosynthesis scores 2 out of 2 while the lowercase spelling is left ungraded](https://formester-strapi.s3.ap-south-1.amazonaws.com/gforms_s8_ungraded_case_mismatch_b8838b5419.jpg)
...
Two things worth setting before you share:

- **Question order.** Turn on **Shuffle question order** under Settings if the quiz is being taken in the same room. It does not shuffle answer options, only the questions themselves.
- **Feedback per question.** Under each answer key, **Add answer feedback** lets you attach an explanation shown after submission. It is the only place you can teach rather than just mark.

![Google Forms Respondent settings with Missed questions and Correct answers switched off while Point values stays on](https://formester-strapi.s3.ap-south-1.amazonaws.com/gforms_s9_respondent_toggles_off_6a38d03e40.jpg)
...
![Google Forms Published options dialog opened from the Publish button](https://formester-strapi.s3.ap-south-1.amazonaws.com/gforms_published_options_set_close_date_c3bca22b2b.jpg)

- **Link.** Shortened with the `forms.gle` option. Fine for a class, awkward in print.
- **QR code.** Not native. Generate one from the published link with any QR tool.
...
Having said this, it is evident that diverse efforts are being made to develop softwares, tools, services, platforms, apps and more to support Online Learning.

As a matter of fact, pursuing a **<a href="https://und.edu/programs/early-childhood-education-bsed/index.html">childhood education degree</a>** online has become more accessible, allowing educators to gain essential skills while adapting to digital learning.
...
- **No timer.** There is no native time limit on a quiz. Every workaround is an add-on or a script. Our guide to [adding a timer to a Google quiz](https://formester.com/blog/how-to-add-a-timer-to-your-google-quiz-includes-latest-alternative-works-without-add-ons-2023/) covers the options.
- **No partial credit.** Checkboxes score all or nothing, and short answer near-misses go ungraded.
- **No score-based branching.** You cannot route someone to remedial content because they scored 4 out of 10.
- **No proctoring or attempt control.** Limit to 1 response requires sign-in, and even then it limits accounts rather than people.
...
<details><summary>Can respondents see their score straight away?</summary><p>Only if <strong>Release grades</strong> is set to Immediately after each submission. Set it to Later, after manual review and Google holds every score until you send them, which also forces Collect email addresses on so it knows where to send. So whether, you want to have some fun with your friends by using a quiz to determine what kind of pizza they are, or create an aptitude test for your career counselling business, or you are a teacher wanting to create an online quiz for your students; All you have to do, is literally, just [sign-up for free and start accessing all the powerful features](https://app.formester.com/users/sign_up)!</p></details>
</section>
