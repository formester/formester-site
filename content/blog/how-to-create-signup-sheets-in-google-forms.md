...
<li><strong>Cap the total:</strong> Settings, then Set close date or response limit. The form closes on its own at the number you type or on the date, and shows a message you write.</li>
...
<p><img src="https://formester-strapi.s3.ap-south-1.amazonaws.com/5cd5480b2d1f28bf_gforms-event-registration-build.gif" alt="Building a form in Google Forms with a name question and a dropdown of options, the same steps a sign up sheet uses" loading="lazy"></p>
...
<p>Back in <strong>Settings</strong>, open <strong>Set close date or response limit</strong>. Type the total number of places and, if the sheet has a deadline, the date. Write the message people see when it closes. The form counts every submission and stops accepting them at the number.</p>
</li>
<li>
...
<p>Google Forms has no per-option capacity. The response limit in Settings caps the whole form, so twenty places across four shifts can all land on the first shift. There are three ways around it.</p>
...
<p><img src="https://formester-strapi.s3.ap-south-1.amazonaws.com/846044d3c5b40cb2_gforms-response-limit.gif" alt="Opening Set close date or response limit in Google Forms settings and typing a response limit" loading="lazy"></p>

<p>Open <strong>Settings</strong> and click <strong>Set close date or response limit</strong>. There are two controls, and they work on their own or together: a number of responses, and a date and time. When either is reached the form stops accepting responses and shows the message you wrote.</p>

<p>Switch on <strong>Limit to 1 response</strong> in the same tab to stop one person taking two places. It requires a Google sign-in, which is the trade: on a public sheet it turns some people away at the door. Leave it off and handle duplicates in the spreadsheet instead.</p>
