...
<div class="fmstr-cmp-oaf-faq__answer">Yes. The Free plan includes 10 forms and 100 responses per month with all field types, the AI generator, drop-off analysis, and payment collection. Good for a single round of a small program. If you expect more than 100 applicants per month, the Personal plan at $13 per month covers 1,000 responses and removes Formester branding.</div>
</details>
