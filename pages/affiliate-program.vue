...
const c0_heroImage = {
  ...
  "imageUrl": "https://formester-strapi.s3.ap-south-1.amazonaws.com/attractive_girl_fashionable_outfit_creats_influence_content_shows_peace_sign_smartphone_front_camera_poses_selfie_smiles_gladfully_poses_urban_place_spends_vacation_big_city_1_d579c6f4ce.png",
  "width": null,
  "height": null,
  "image": null
}
...
const c2_itemList = [
  {
    ...
    "description": "Share Formester with your followers and earn 30% recurring commissions every month. Highlight its simplicity, powerful features, and flexibility to help your audience build smarter forms easily.",
    "description_markdown": "Share Formester with your followers and earn 30% recurring commissions every month. Highlight its simplicity, powerful features, and flexibility to help your audience build smarter forms easily.",
    "icon": null,
    "cardImage": {
      "id": 3554,
      "imageAlt": "attractive-girl-fashionable-outfit-creats-influence-content-shows-peace-sign-smartphone-front-camera-poses-selfie-smiles-gladfully-poses-urban-place-spends-vacation-big-city",
  ...
  },
  {
    ...
    "description": "Recommend Formester in your blog posts or guides. Explain how it saves time, simplifies form building, and improves workflows while earning 30% recurring commissions for every user who upgrades.",
    "description_markdown": "Recommend Formester in your blog posts or guides. Explain how it saves time, simplifies form building, and improves workflows while earning 30% recurring commissions for every user who upgrades.",
    "icon": null,
    "cardImage": {
      "id": 3553,
  ...
  },
  {
    ...
    "description": "Add Formester banners or links to your site and turn traffic into steady income. Promote a reliable, fully featured form builder that helps your visitors create professional forms with ease and speed.",
    "description_markdown": "Add Formester banners or links to your site and turn traffic into steady income. Promote a reliable, fully featured form builder that helps your visitors create professional forms with ease and speed.",
    "icon": null,
    "cardImage": {
      "id": 3558,
  ...
  },
  {
    ...
    "description": "Promote Formester to your email list with practical tips or guides. Showcase how it helps users create smart forms and earn 30% recurring commissions whenever someone upgrades through your referral link.",
    "description_markdown": "Promote Formester to your email list with practical tips or guides. Showcase how it helps users create smart forms and earn 30% recurring commissions whenever someone upgrades through your referral link.",
    "icon": null,
    "cardImage": {
      "id": 3557,
  ...
  },
  {
    ...
    "description": "Introduce Formester to your clients and show how it automates workflows, collects data faster, and boosts efficiency while earning recurring commissions from every upgraded customer you refer.",
    "description_markdown": "Introduce Formester to your clients and show how it automates workflows, collects data faster, and boosts efficiency while earning recurring commissions from every upgraded customer you refer.",
    "icon": null,
    "cardImage": {
      "id": 3556,
  ...
  },
  {
    ...
    "description": "Feature Formester in your videos or tutorials and show how easy it is to build forms, quizzes, and surveys. Add your link in descriptions and earn 30% recurring commissions for every upgrade.",
    "description_markdown": "Feature Formester in your videos or tutorials and show how easy it is to build forms, quizzes, and surveys. Add your link in descriptions and earn 30% recurring commissions for every upgrade.",
    "icon": null,
    "cardImage": {
      "id": 3555,
...
const c4_faqList = [
  ...
  },
  {
    ...
    "body_markdown": "Anyone with an online presence: bloggers, influencers, freelancers, website owners, and small business owners.",
    "list": []
  },
  {
    "id": 1338,
...
useHead({
  ...
  "meta": [
    ...
    },
    {
      "hid": "description",
      "name": "description",
      "content": "Join Formester’s affiliate program and earn 30% commission for 12 months by recommending Formester to your audience!"
    },
    {
      "hid": "og:site_name",
      "name": "og:site_name",
