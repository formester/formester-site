...
<tr><td>Free tier</td><td class="fmstr-cmp-ifb-cmp__col-us">Unlimited forms, unlimited responses, AI builder included</td><td>5 forms, 100 submissions/mo</td><td>10 inspections/mo, severely capped</td></tr>
...
<div class="fmstr-cmp-ifb-cta__stat"><span class="fmstr-cmp-ifb-cta__stat-num">Unlimited</span><span class="fmstr-cmp-ifb-cta__stat-label">Free responses</span></div>
...
useHead({
  ...
  "meta": [
    ...
    },
    {
      "hid": "description",
      "name": "description",
      "content": "Build inspection forms that work offline, capture photos, run conditional logic, and sync the moment you're back online. Free to start, no credit card."
    },
    {
      "hid": "og:site_name",
      "name": "og:site_name",
    ...
    "@graph": [
      {
        ...
        "inLanguage": "en-US",
        "description": "Build inspection forms that work offline, capture photos, run conditional logic, and sync the moment you're back online. Free to start, no credit card."
      },
      {
        "@id": "https://formester.com/inspection-form-builder/#breadcrumb",
        "@type": "BreadcrumbList",
      ...
      },
      {
        ...
        "description": "Inspection forms that work fully offline on Android, iOS, tablets, and laptops. Camera photo capture, conditional logic, GPS, e-signatures, and automatic sync on reconnect.",
        "aggregateRating": {
