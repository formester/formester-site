<template>
  <div>
    <HeroTabShowcase
      description="The smarter alternative to Formstack with affordable plans, full customization, no bugs and seamless automation."
      hideIcons
      :title="c0_title"
      :button="c0_button"
    ...
    <IntegrationsShowcase
      description="Improve your workflows with zero coding."
      :title="c12_title"
      class="page-component-item"
    />

    <Usecase
      description="Learn how Formester can help you!"
      :title="c13_title"
      :usecase="c13_usecase"
      class="page-component-item"
    />
