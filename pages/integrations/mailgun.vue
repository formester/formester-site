<template>
  <div>
    ...
    <CardGrid
      ...
      description="Route every form email through your Mailgun account for deliverability you control."
      columns="2"
      :title="c2_title"
      :cards="c2_cards"
      class="page-component-item"
    ...
    <StickyStepsSection
      badge="How it works"
      heading="Connect Mailgun in 3 steps"
    ...
    <CtaDark
      badge="Free to start"
      heading="Send form emails through Mailgun today"
...
const c0_buttons = [
  {
    id: 1803,
    link: 'https://help.formester.com/en/article/mailgun-integration-u3twqq/',
...
const c2_cards = [
  ...
  },
  {
    ...
    body: "Mailgun's sending infrastructure keeps your confirmations and alerts out of spam folders.",
    mockHtml: null,
    icon: null,
  },
  {
...
const c6_faqList = [
  {
    id: 2764,
    header: 'What does the Mailgun integration do?',
    body: "It routes the emails your forms send — confirmations, notifications, and auto-replies — through your own Mailgun account, so they come from your domain with Mailgun's deliverability.",
    body_markdown: '',
    list: [],
  },
  {
    id: 2763,
    header: 'How do I connect Mailgun to Formester?',
    body: 'From your dashboard, open Integrations and click Add integration under Custom SMTP. In the Add SMTP Account modal, select Mailgun as the service and enter your username, integration password, and from name and address — the port and SMTP server fill in for you.',
    body_markdown: '',
    list: [],
  },
  {
  ...
  },
  {
    ...
    body: 'Check that your Mailgun credentials are still valid and re-save the integration. If the issue continues, our support team can help.',
    body_markdown: '',
    list: [],
  },
  {
...
useHead({
  title: 'Mailgun Integration for Online Forms | Formester',
  link: [
    {
      hid: 'canonical',
      rel: 'canonical',
      href: 'https://formester.com/integrations/mailgun/',
    },
  ],
  meta: [
    {
      property: 'article:modified_time',
      content: '2026-06-14T15:16:54.895Z',
    },
    {
      hid: 'description',
      name: 'description',
      content:
        'Send form confirmations and notifications through your own Mailgun account. Branded, reliable email delivery from your forms — set up in minutes.',
    },
    {
      hid: 'og:site_name',
      name: 'og:site_name',
      content: 'Mailgun Integration for Online Forms | Formester',
    },
    {
      hid: 'og:type',
      property: 'og:type',
    ...
    },
    {
      hid: 'og:url',
      property: 'og:url',
      content: 'https://formester.com/integrations/mailgun/',
    },
    {
      hid: 'og:title',
      property: 'og:title',
    ...
    },
    {
      hid: 'og:image:alt',
      name: 'og:image:alt',
      content: 'Formester Mailgun integration',
    },
    {
      hid: 'twitter:url',
      name: 'twitter:url',
...
useJsonld([
  {
    ...
    type: '{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What does the Mailgun integration do?", "acceptedAnswer": {"@type": "Answer", "text": "It routes the emails your forms send — confirmations, notifications, and auto-replies — through your own Mailgun account, so they come from your domain with Mailgun\'s deliverability."}}, {"@type": "Question", "name": "How do I connect Mailgun to Formester?", "acceptedAnswer": {"@type": "Answer", "text": "From your dashboard, open Integrations and click Add integration under Custom SMTP. In the Add SMTP Account modal, select Mailgun as the service and enter your username, integration password, and from name and address — the port and SMTP server fill in for you."}}, {"@type": "Question", "name": "Which emails will use this integration?", "acceptedAnswer": {"@type": "Answer", "text": "Any form email you configure — respondent confirmations, internal alerts to your team, and automated replies."}}, {"@type": "Question", "name": "What if emails stop sending?", "acceptedAnswer": {"@type": "Answer", "text": "Check that your Mailgun credentials are still valid and re-save the integration. If the issue continues, our support team can help."}}, {"@type": "Question", "name": "What is Formester?", "acceptedAnswer": {"@type": "Answer", "text": "Formester is an online form builder for creating forms, surveys, and quizzes with a drag-and-drop editor or AI. It connects with the tools your team already uses — Google Sheets, Slack, HubSpot, Zapier, and more — so your form data flows wherever you need it."}}]}',
  },
  {
    '@context': 'https://schema.org',
    type: '{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://formester.com/"}, {"@type": "ListItem", "position": 2, "name": "Integrations", "item": "https://formester.com/integrations/"}, {"@type": "ListItem", "position": 3, "name": "Mailgun", "item": "https://formester.com/integrations/mailgun/"}]}',
  },
])
</script>
