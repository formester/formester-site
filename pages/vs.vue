...
const c2_itemList = [
  {
    ...
    "description_markdown": "Typeform alternative that's cleaner, faster, and simpler.\n\n**[Learn more ->](/typeform-alternative/)**",
    "icon": null,
    "cardImage": {
      "id": 2405,
  ...
  },
  {
    ...
    "description_markdown": "Jotform alternative with easier steps and full control.\n\n**[Learn more ->](/jotform-alternative/)**",
    "icon": null,
    "cardImage": {
      "id": 2408,
  ...
  },
  {
    ...
    "description_markdown": "Google Forms alternative with smarter, modern forms.\n\n**[Learn more ->](/google-forms-alternative/)**",
    "icon": null,
    "cardImage": {
      "id": 2406,
  ...
  },
  {
    ...
    "description_markdown": "Forms App alternative with quick setup and more options.\n\n**[Learn more ->](/forms-app-alternative/)**",
    "icon": null,
    "cardImage": {
      "id": 2404,
  ...
  },
  {
    ...
    "description_markdown": "Zoho Form alternative that's clean, fast, and simple.\n\n**[Learn more ->](/zoho-forms-alternative/)**",
    "icon": null,
    "cardImage": {
      "id": 2407,
  ...
  },
  {
    ...
    "description_markdown": "Paperform alternative with better logic and speed.\n\n**[Learn more ->](/paperform-alternative/)**",
    "icon": null,
    "cardImage": {
      "id": 2411,
  ...
  },
  {
    ...
    "description_markdown": "Formstack alternative without all the extra stuff.\n\n**[Learn more ->](/formstack-alternative/)**",
    "icon": null,
    "cardImage": {
      "id": 2412,
...
const c5_faqList = [
  {
    ...
    "body_markdown": "Yes. You get all the modern features of Typeform—like logic jumps and clean layouts—without the price or learning curve.",
    "list": []
  },
  {
    "id": 1078,
...
useHead({
  ...
  "meta": [
    ...
    },
    {
      "hid": "description",
      "name": "description",
      "content": "Create modern, responsive forms without the clutter. Build faster, connect with your tools, and grow without limits using a smarter form builder."
    },
    {
      "hid": "og:site_name",
      "name": "og:site_name",
