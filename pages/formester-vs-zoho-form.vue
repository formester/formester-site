<template>
  <div>
        ...
        <div class="row my-5">
          ...
          >
            <h1 class="section__heading">
              Zoho Form Alternative that Gives <span class="highlight__text">More</span>
            </h1>
    ...
    <section class="container text-center">
      <h2 class="section__heading">Formester vs. Zoho Form: Head To Head</h2>
    ...
    meta() {
      const metaData = {
        ...
        keywords: [
          ...
          'zoho form competitor',
          'free alternative to zoho form',
          'zoho form alternative open source',
          'zoho form alternative wordpress',
          'zoho form alternatives free',
          'zoho form open source alternative',
          'best zoho form alternative',
          'zoho form wordpress alternative',
          'zoho form alternative reddit',
          'zoho form alternative for wordpress',
          'open source zoho form alternative',
          'zoho form alternative free reddit',
          'zoho form similar free',
          'zoho form equivalent',
          'wordpress zoho form alternative',
          'free zoho form alternatives',
          'free alternative zoho form',
          'zoho form like open source',
          'similar to zoho form free',
          'privacy focused alternatives to zoho form',
          'free zoho form alternative with conditional formatting',
          'open source zoho form alternatives',
          'forms',
          'web forms',
          'formester',
          'online forms',
          'online web forms',
          'zoho form wufoo alternatives',
          'cheaper zoho form alternative',
          'easier alternatives to zoho form',
          'paid alternatives to zoho form',
          'private alternatives to zoho form',
          'zoho form alternate thank you pages',
          'zoho form alternates commerce',
          'zoho form alternatives cheaper',
          'zoho form alternative quiz',
          'better zoho form alternatives',
          'completele free alternatives to zoho form',
          'rank alternatives zoho form',
          'zoho form alternative for gravity forms',
          'zoho form alternative for registration',
          'zoho form alternative squarespace',
          'zoho form alternative with branching',
          'zoho form cheaper alternatives',
          'zoho form wordpress alternative',
          'zoho form alternative free reddit',
      ...
      link: [
        {
          hid: 'canonical',
          rel: 'canonical',
          href: 'https://formester.com/formester-vs-zoho-form/',
        },
      ],
    }
  },
