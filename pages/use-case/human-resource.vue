<template>
  <div>
    <Hero />
    <StandOutFeatureSection heading="Challenges in HR Data Management" :features="typeformStandOutFeatures" />
    ...
    <CreateFormInThreeSteps
      section-heading="Create Customizable HR Forms with a simple 3 Step Process"
      :steps="stepsToCreateForm"
    />
    <KeyBenefits />
    <SeamlessIntegration />
    <div class="container py-5">
      ...
      <div class="row mt-4">
        <BlogCard v-for="article in articles" :key="article.slug" class="col-lg-4 mt-3 mb-5" :article="article" />
      </div>
    </div>
...
const stepsToCreateForm = {
  step1: {
    ...
    description:
      'Sign up with your email address to start using Formester. Our free plan allows you to create 10 forms with 100 submissions per month.',
  },
  step2: {
    title: 'Select a template or Create a form',
    description:
      'We have multiple customizable templates for HR functions along with an intuitive drag and drop form builder with personalized branding.',
  },
  step3: {
    title: 'Publish and Share the Form',
    description:
      'Once the form is created, share it via link or embed it in your website. Our built-in analytics turn form inputs into actionable insights.',
  },
}
...
useHead({
  title: 'Automate Human Resource Operations | No-Code Form Builder',
  meta: [...meta.value],
  link: [{ rel: 'canonical', href: 'https://formester.com/use-case/human-resource/' }],
})
...
const HelpingFeaturesForHr = [
  ...
  },
  {
    ...
    imgUrl: 'hr-solution/HelpingFeaturesForHr/get-data-driven-performance.svg',
  },
  {
    ...
    imgUrl: 'hr-solution/HelpingFeaturesForHr/support-employee-growth.svg',
  },
]
