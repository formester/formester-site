<template>
  <div>
      ...
      <div class="feature__hero">
        <div class="container">
          <div class="d-flex flex-column justify-content-center align-items-center text-center upper-margin">
            <h1 class="hero__heading pt-3">Designing Forms with <span class="hglt">Visual Brilliance!</span></h1>
            <p class="hero__subheading mt-3">
              Unlock the true potential of form building with Typeform. At Formester, we're committed to providing you
              with a comprehensive guide to help you navigate the world of form creation. Discover the features, tips,
              and tricks that make Typeform a top choice for form builders!
            </p>
          </div>
          <div class="d-flex align-items-center justify-content-center mt-5">
            <nuxt-img src="/typeform-101/typeform-hero.svg" alt="Hero-Image" class="img-fluid hero__image" />
          </div>
        </div>
      </div>
    </div>

    <KeyFeatures heading="Key Features of Typeform" :keyFeatures="typeformKeyFeatures" />
    ...
    />
    <PopularUseCase heading="Popular Use-Cases of Typeform" :useCases="typeformPopularUseCases" bootstrapColWidth="3" />
    <Limitations heading="Limitations of Typeform" :limitations="typeformLimitations" />
    <FormBuilderComparisionTable heading="Comparing Typeform with Other Leading Form Builders" />
    <WhyChooseFormester />
...
const meta = computed(() => {
  const metaData = {
    ...
    description:
      "Discover everything about form building using Typeform: Presented by Formester, uncover Typeform's key features, FAQs, limitations & more!",
    ...
    keywords: [
      ...
      'Is Typeform a good company?',
      'limitations of typeform',
      'is typeform expensive?',
      'typeform pricing',
      'typeform examples',
      'typeform use cases',
      'form creation',
...
const typeformStandOutFeatures = [
  ...
  },
  {
    ...
    description: 'Connect Typeform with your favorite tools and apps, streamlining your workflow effortlessly.',
...
const typeformLimitations = [
  {
    ...
    description: "Typeform's unique design can be complex for those new to the platform, requiring a learning curve.",
  ...
  },
  {
    ...
    description: "Typeform's reporting and analytics features are basic compared to dedicated data analysis tools.",
    img: 'typeform-101/limitations/limited-reporting-and-analytics.svg',
  },
  {
    title: 'Conditional Logic Complexity',
    description: 'Implementing conditional logic in Typeform can be complex for intricate workflows.',
