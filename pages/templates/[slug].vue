...
const meta = computed(() => {
  const { name, description, metaTitle, metaDescription, previewImageUrl } = template.value || {}
  ...
  const metaData = {
    ...
    mainImage: previewImageUrl || 'https://formester.com/formester-logo-meta-image.png',
