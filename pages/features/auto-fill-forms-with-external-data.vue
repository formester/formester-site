...
const c0_description = "Start from a ready-made Airtable, Google Sheets, or Notion template — or write a short JavaScript fetch of your own. Formester runs it when the form loads, pulls the matching record, and drops each value into place. Less typing, fewer errors, faster submissions."
...
useHead({
  ...
  "meta": [
    ...
    },
    {
      "hid": "description",
      "name": "description",
      "content": "Auto-fill form fields from an external source. Start from a ready-made Airtable, Google Sheets, or Notion template, or write your own JavaScript fetch — the record loads and your fields populate automatically."
    },
    {
      "hid": "og:site_name",
      "name": "og:site_name",
