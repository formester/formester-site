...
const c2_steps = [
  {
    ...
    description:
      "Publish your form, or run a quick test submission, so you have responses to work with. Every entry lands in your form's results.",
    rawHtml:
  ...
  },
  {
    ...
    description:
      'Hit the PDF icon under Submitted At. Formester lays each field out neatly and generates a clean PDF document you can download instantly.',
    rawHtml:
      "<div style='display:flex;align-items:center;gap:9px;border:1px solid #eaecf0;border-radius:10px;padding:9px 12px;background:#fff;'><span style='display:inline-flex;align-items:center;justify-content:center;width:20px;height:24px;border-radius:4px;background:#fef3f2;color:#d92d20;font-size:8px;font-weight:800;line-height:1;'>PDF</span><div style='font-size:12px;font-weight:600;color:#101828;line-height:1.1;'>Agreement.pdf</div><span style='margin-left:auto;display:inline-flex;align-items:center;gap:5px;font-size:11px;font-weight:600;color:#6434d0;line-height:1.1;'><svg width='12' height='12' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2.4'><path d='M12 3v12M7 10l5 5 5-5M5 21h14'/></svg>Download</span></div>",
    image: null,
  },
  {
    id: 144,
    ...
    description:
      'Want respondents to keep their own record? Turn on the Autoresponder under Automation to attach the PDF to their confirmation email automatically.',
    rawHtml:
...
const c4_cards = [
  ...
  },
  {
    ...
    mockHtml:
      "<div style='display:flex;align-items:center;gap:9px;border:1px solid #eaecf0;border-radius:9px;padding:9px 11px;background:#fff;'><span style='width:24px;height:24px;border-radius:7px;background:#f0ebfa;color:#6434d0;display:inline-flex;align-items:center;justify-content:center;'><svg width='13' height='13' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2'><path d='M12 2l8 4v6c0 5-3.5 8-8 10-4.5-2-8-5-8-10V6z'/></svg></span><div style='font-size:11px;color:#101828;line-height:1.3;'>Locked PDF record<br><span style='font-size:9.5px;color:#98a2b3;'>Audit-ready · tamper-resistant</span></div></div>",
    icon: null,
  },
]
const c5_heading = [
...
useHead({
  ...
  meta: [
    ...
    },
    {
      ...
      name: 'description',
      content:
        'Export form submissions as formatted PDF documents — download a single response or in bulk, share by email, archive for records, and auto-attach to notifications. Available on the Business plan.',
    },
    {
      hid: 'og:site_name',
      name: 'og:site_name',
    ...
    },
    {
      ...
      property: 'og:image',
      content:
        'https://formester-strapi.s3.ap-south-1.amazonaws.com/formester_s_pdf_export_feature_page_hero_image_eafaebc6e8.png',
    },
    {
      hid: 'og:image:alt',
      name: 'og:image:alt',
