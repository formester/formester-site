...
const c3_cards = [
  {
    ...
    mockHtml:
      "<div style='display:flex;align-items:center;gap:8px;background:#fff;border:1px solid #eaecf0;border-radius:9px;padding:9px 11px;'><svg width='13' height='13' viewBox='0 0 24 24' fill='none' stroke='#12b76a' stroke-width='2.2' style='flex-shrink:0;'><rect x='4' y='11' width='16' height='10' rx='2'/><path d='M8 11V7a4 4 0 0 1 8 0v4'/></svg><span style='font-size:11px;line-height:1.2;'><span style='color:#6434d0;font-weight:700;'>forms.</span><span style='color:#101828;font-weight:700;'>yourbrand.com</span></span></div>",
    icon: null,
  },
  {
    id: 513,
  ...
  },
  {
    ...
    mockHtml:
      "<div style='display:flex;align-items:center;gap:8px;background:#fff;border:1px solid #eaecf0;border-radius:9px;padding:9px 11px;'><span style='font-size:9px;font-weight:700;color:#027a48;background:#ecfdf3;border-radius:999px;padding:3px 9px;line-height:1.2;'>Verified sender</span><span style='font-size:11px;color:#475467;line-height:1.2;'>on your domain</span></div>",
    icon: null,
  },
  {
    id: 516,
...
useHead({
  ...
  meta: [
    ...
    },
    {
      ...
      name: 'description',
      content:
        'Serve your forms on your own branded subdomain like forms.yourbrand.com instead of a generic Formester URL. Build trust, stay on-brand, and improve deliverability with a quick CNAME setup.',
    },
    {
      hid: 'og:site_name',
      name: 'og:site_name',
