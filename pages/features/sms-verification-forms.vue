<template>
  <div>
    <HeroRowLayout
      title="Create Secure SMS Verification Forms Easily"
    ...
    <ThreeColBenefits
      description="Add SMS verification your forms to confirm real users and prevent fake submissions. Protect every SMS verification form with built-in phone validation."
      :title="c3_title"
    ...
    <TestimonialsV2
      description="Find what our customers have to say about their experience with us!"
      version="home"
      :heading="c8_heading"
      :testimonials="c8_testimonials"
      class="page-component-item"
    />
