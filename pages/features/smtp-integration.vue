...
const c2_description =
  "By default, form emails go out from Formester's sender. Connect your own email and every notification and auto-reply comes from your address instead — better deliverability and instant brand trust."
const c2_title = [
  {
    id: 4875,
    text: 'Your forms, ',
...
const c3_steps = [
  ...
  },
  {
    ...
    description:
      "Open your form's Email Notifications and Autoresponders and select your new address as the sender. From now on every alert and auto-reply for that form sends from your own email.",
    rawHtml:
...
useHead({
  ...
  meta: [
    ...
    },
    {
      ...
      name: 'description',
      content:
        "Connect Gmail, Outlook, or any SMTP server — Mailgun, SendGrid, Amazon SES — and send your form's notifications and autoresponders from your own address. Better deliverability and brand trust, no code.",
    },
    {
      hid: 'og:site_name',
      name: 'og:site_name',
    ...
    },
    {
      hid: 'keywords',
      name: 'keywords',
      content: ['send form emails from your own domain'],
    },
  ],
})
useJsonld([
