...
useHead({
  ...
  "meta": [
    ...
    },
    {
      "hid": "description",
      "name": "description",
      "content": "Translate one form into multiple languages and let respondents choose their own. Reach a global audience with multi-language form translations — no duplicate forms to maintain."
    },
    {
      "hid": "og:site_name",
      "name": "og:site_name",
    ...
    },
    {
      "hid": "og:image",
      "property": "og:image",
      "content": "https://formester-strapi.s3.ap-south-1.amazonaws.com/formester_s_multilingual_forms_feature_page_hero_image_099a56518d.png"
    },
    {
      "hid": "og:image:alt",
      "name": "og:image:alt",
