    ...
    <section class="page-component-item">
      <div class="raw-html-content">
        <section class="cfl-sec">
          <div class="cfl-wrap">
            <div class="cfl-head">
              <span class="cfl-eyebrow">Access control</span>
              <h2 class="cfl-h2">Manage permissions at three levels</h2>
              <p class="cfl-lead">
                Set access where it makes sense — across your whole organization, within a team, or on a single form or
                survey.
              </p>
            </div>
            <div class="cfl-grid">
              <div class="cfl-card">
                <div class="cfl-icon">1</div>
                <div>
                  <span class="cfl-kicker">Organization</span>
                  <h3 class="cfl-title">Account-wide</h3>
                </div>
                <p class="cfl-body">Invite members across your entire account and give each one of two access types.</p>
                <div class="cfl-roles">
                  <div class="cfl-role">
                    <b>Admin</b><span>Full control over every form and setting in your organization.</span>
                  </div>
                  <div class="cfl-role">
                    <b>Staff</b><span>Access only the forms they were given at the form level.</span>
                  </div>
                </div>
              </div>
              <div class="cfl-card">
                <div class="cfl-icon">2</div>
                <div>
                  <span class="cfl-kicker">Team</span>
                  <h3 class="cfl-title">Per team</h3>
                </div>
                <p class="cfl-body">
                  Create teams, invite members by email, and manage access for each team separately.
                </p>
                <div class="cfl-roles">
                  <div class="cfl-role">
                    <b>Maintainer</b><span>Manages members and roles, with full access to the team’s forms.</span>
                  </div>
                  <div class="cfl-role">
                    <b>Member</b><span>Works on forms assigned to the team but can’t manage members.</span>
                  </div>
                </div>
              </div>
              <div class="cfl-card">
                <div class="cfl-icon">3</div>
                <div>
                  <span class="cfl-kicker">Form &amp; survey</span>
                  <h3 class="cfl-title">Per form</h3>
                </div>
                <p class="cfl-body">From the Share tab, assign roles to individuals or whole teams on each form.</p>
                <div class="cfl-roles">
                  <div class="cfl-role">
                    <b>Maintainer · Editor</b
                    ><span>Manage access and edit content, or edit content and submissions only.</span>
                  </div>
                  <div class="cfl-role">
                    <b>Viewer · Submitter</b><span>View submissions and analytics, or simply submit the form.</span>
                  </div>
                </div>
              </div>
            </div>
...
const c2_cards = [
  ...
  },
  {
    ...
    mockHtml:
      "<div style='display:flex;align-items:center;gap:10px;'><span style='width:30px;height:30px;border-radius:8px;background:#f0ebfa;color:#6434d0;display:flex;align-items:center;justify-content:center;font-weight:700;'>F</span><div style='flex:1;min-width:0;'><div style='font-size:12px;font-weight:600;color:#101828;'>Onboarding form</div><div style='font-size:11px;color:#697586;'>Shared with 4 teammates</div></div><span style='display:inline-flex;'><span style='width:20px;height:20px;border-radius:50%;border:2px solid #fff;background:#6434d0;'></span><span style='width:20px;height:20px;border-radius:50%;border:2px solid #fff;background:#0e9384;margin-left:-7px;'></span><span style='width:20px;height:20px;border-radius:50%;border:2px solid #fff;background:#dd2590;margin-left:-7px;'></span></span></div>",
    icon: null,
  },
  {
    id: 483,
  ...
  },
  {
    ...
    mockHtml:
      "<div style='font-size:12px;color:#475467;'><div style='display:flex;align-items:center;gap:8px;'><span style='width:16px;height:13px;border-radius:3px;background:#6434d0;display:inline-block;'></span><span style='font-weight:600;color:#101828;'>Marketing team</span></div><div style='margin-top:7px;padding-left:24px;color:#697586;'>Lead capture form · Event survey</div></div>",
    icon: null,
  },
  {
    id: 486,
    ...
    mockHtml:
      "<div style='display:flex;align-items:center;gap:7px;'><span style='width:22px;height:22px;border-radius:6px;background:#6434d0;'></span><span style='width:22px;height:22px;border-radius:6px;background:#0e9384;'></span><span style='width:22px;height:22px;border-radius:6px;background:#101828;'></span><span style='font-size:11px;color:#697586;margin-left:5px;'>Brand kit applied</span></div>",
    icon: null,
  },
  {
    id: 485,
    ...
    mockHtml:
      "<div style='display:flex;align-items:center;gap:8px;font-size:12px;color:#475467;'><span style='width:20px;height:20px;border-radius:5px;background:#ecfdf3;color:#027a48;display:inline-flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;'>✓</span>GDPR · Audit log · SSO</div>",
    icon: null,
  },
]
const c4_steps = [
  {
    ...
    description:
      'In the Teams section, invite by email and set their role as Member — not Maintainer, who can edit the whole form.',
    rawHtml: null,
    image: null,
  },
  {
  ...
  },
  {
    ...
    description:
      'Choose Add Role, give it a name, then add members or a whole team. Only they can edit and fill out this field.',
    rawHtml: null,
    image: null,
  },
  {
...
useHead({
  ...
  meta: [
    ...
    },
    {
      ...
      name: 'description',
      content:
        'Build forms together as a team. Assign roles, control who can view, edit, and manage submissions, and set permissions at the organization, team, and form level.',
    },
    {
      hid: 'og:site_name',
      name: 'og:site_name',
