<template>
  <div>
    ...
    <CardGrid
      ...
      description="The form does the data-gathering. The AI does the reading, summarizing, scoring, and routing on the structured output — every time someone submits."
      columns="3"
      :title="c3_title"
      :cards="c3_cards"
      class="page-component-item"
    ...
    <CtaDark
      ...
      heading="Run an AI workflow on your next submission"
      description="Write a prompt, pick a trigger, and choose where the output goes. Set it up once and every new response is processed automatically."
      :buttons="c7_buttons"
      class="page-component-item"
    />
  </div>
