<template>
  <div>
    ...
    <ComparisonTable
      ...
      colUs="With Formester"
      colThem="Without protection"
      :note="c2_note"
      :title="c2_title"
      :rows="c2_rows"
      class="page-component-item"
    ...
    <CardGrid
      eyebrow="Layers of defense"
      description="Each layer catches what the others miss. Turn them on individually or stack them for forms that bots can't get past."
      columns="2"
      :title="c3_title"
      :cards="c3_cards"
      class="page-component-item"
    ...
    <StatsBanner
      ...
      heading="Spam stopped before it reaches you"
      description="Layered protection catches the overwhelming majority of automated submissions at the door — so the entries in your dashboard are the ones worth reading."
      :stats="c4_stats"
      class="page-component-item"
    />
    ...
    <StickyStepsSection
      badge="How it works"
      heading="Turn on spam protection in three steps"
      description="Pick your layers, toggle them on, and Formester filters every submission automatically — no code required."
      background="#f9fafb"
      :steps="c5_steps"
      :buttons="c5_buttons"
      class="page-component-item"
    ...
    <CtaDark
      badge="Free to start"
      heading="Block spam before it reaches your inbox"
      description="Switch on smart CAPTCHA, honeypot, rate limiting, and AI detection in one click and keep your form data clean."
      :buttons="c8_buttons"
      class="page-component-item"
    />
  </div>
