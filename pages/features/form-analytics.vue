<template>
  <div>
    ...
    <StatsBanner
      ...
      heading="Every form, measured out of the box"
    ...
    <StatsBanner
      variant="band"
      heading="Built for teams that act on their data"
      :stats="c4_stats"
      class="page-component-item"
    />
    ...
    <ComparisonTable
      ...
      colUs="Formester"
      colThem="Basic form tool"
      note="A basic form tool tells you a response arrived. Form analytics tells you who sent it, where they came from, and where everyone else dropped off."
      :title="c5_title"
      :rows="c5_rows"
      class="page-component-item"
    />
    ...
    <CtaDark
      badge="Free to start"
      heading="Know exactly how your forms perform"
      description="Turn on a form and start measuring views, submissions, and drop-off today."
      :buttons="c9_buttons"
      class="page-component-item"
    />
  </div>
