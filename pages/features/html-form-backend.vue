<template>
  <div>
    ...
    <CardGrid
      ...
      description="Keep your own markup and styling. Point the form action at Formester and everything behind it is handled for you."
      columns="3"
      :title="c2_title"
      :cards="c2_cards"
      class="page-component-item"
    ...
    <StickyStepsSection
      badge="How it works"
      heading="Wire up your HTML form in three steps"
      description="Design a form for your site, point its action at us, and confirm your email. That's the whole setup."
      background="#f9fafb"
      :steps="c3_steps"
      :buttons="c3_buttons"
      class="page-component-item"
    ...
    <CtaDark
      ...
      heading="Power your HTML form with Formester"
      description="Set the action, add your fields, and start collecting submissions in minutes. Notifications, spam filtering, and exports included."
      :buttons="c7_buttons"
      class="page-component-item"
    />
  </div>
