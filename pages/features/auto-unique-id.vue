<template>
  <div>
    ...
    <CardGrid
      ...
      description="Add one field and every submission arrives tagged, formatted, and ready to track — no manual numbering, no duplicates, no guesswork."
      columns="3"
      :title="c2_title"
      :cards="c2_cards"
      class="page-component-item"
    ...
    <StickyStepsSection
      badge="How it works"
      heading="Set up auto unique IDs in three steps"
      description="Drop in the field, set the format you want, and publish. Every submission from then on gets its own ID automatically."
      background="#f9fafb"
      :steps="c3_steps"
      :buttons="c3_buttons"
      class="page-component-item"
    ...
    <CardGrid
      ...
      description="Anywhere you need to reference a single response cleanly, a unique ID keeps records organized and conversations clear."
      columns="2"
      :title="c4_title"
      :cards="c4_cards"
      class="page-component-item"
    ...
    <CtaDark
      badge="Free to start"
      heading="Track every submission with its own ID"
      description="Add the Auto Unique ID field, set your prefix and format, and let every response arrive with a reference number you can search, share, and trust."
      :buttons="c7_buttons"
      class="page-component-item"
    />
  </div>
